           ...
           <div className="container mx-auto px-6 py-4 flex justify-between items-center">
                ...
                <nav className='hidden md:block'>
                    <ul className="flex space-x-10 font-semibold text-lg tracking-wide">
                        <li>
                            <Link to="/" className="hover:text-yellow-200 hover:scale-105 transition-all duration-200">Home</Link>
                        </li>
                        <li>
                            <Link to="/Shop" className="hover:text-yellow-200 hover:scale-105 transition-all duration-200">Shop</Link>
                        </li>
                        <li>
                            <Link to="/aboutpage" className="hover:text-yellow-200 hover:scale-105 transition-all duration-200">About</Link>
                        </li>
                        <li>
                            <Link to="/contactpage" className="hover:text-yellow-200 hover:scale-105 transition-all duration-200">Contact</Link>
                        </li>
                    </ul>
                </nav>

                <nav className={`p-4 md:hidden fixed w-[40vw]   bg-black ${toggle == true?"left-0":"left-[-100%]"} top-0  h-screen  flex-col`}>
