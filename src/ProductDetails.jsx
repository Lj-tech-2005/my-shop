...
export default function ProductDetails() {
  ...
  return (
    <div className="max-w-4xl my-10 mx-auto p-6 bg-white mt-30 shadow-lg rounded-lg">
      <div className="flex flex-col md:flex-row gap-6">
        <div className="flex flex-col items-center gap-4 mt-3 text-yellow-500">
          {
            ...
            product?.images?.map((path, index) => {
              ...
              return (
                <img key={index} className="h-[30px] w-[30px]" src={path}></img>
        ...
        <div className="flex-1">
          ...
          <div className="mt-4 flex gap-3">
            <button onClick={() => { addtocart(product.id) }} className="bg-green-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 cursor-pointer hover:bg-blue-700 transition">
